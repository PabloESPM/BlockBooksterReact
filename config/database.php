...
return [
    ...
    | usar como su conexión por defecto para las operaciones de la base de datos. Esta es
    | la conexión que se utilizará a menos que se especifique explícitamente otra conexión
    | cuando ejecute una consulta / instrucción.
    |
    */
    ...
    | es compatible con Laravel. Es libre de agregar o eliminar conexiones.
    |
    */
    ...
    | su aplicación. Con esta información, podemos determinar cuáles de las
    | migraciones en disco no se han ejecutado realmente en la base de datos.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Redis es un almacén de clave-valor rápido, avanzado y de código abierto que también
    | proporciona un cuerpo de comandos más rico que un sistema de clave-valor típico
